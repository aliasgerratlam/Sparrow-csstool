...
export const PLAN_DISPLAY: Record<PlanId, PlanDisplay> = {
  free: {
    id: 'free',
    name: 'Free',
    tagline: 'Perfect for exploring Sparrow.',
    monthlyPrice: '$0',
    yearlyPrice: '$0',
    features: [
      'Inspect mode (color format locked)',
      '3 annotations per site / day',
      'Color extractor (view only)',
    ],
  ...
  pro: {
    id: 'pro',
    name: 'Pro',
    tagline: 'Everything you need for everyday work.',
    monthlyPrice: '$9',
    yearlyPrice: '$90',
    features: [
      'Inspect + CSS color format switching',
      '10 annotations per site / day',
      'Color Change & Font modes',
      'Assets downloader',
      'Priority support',
    ],
    cta: 'Get Pro',
